...
var LDAvis = function(to_select, data_or_file_name, color1, color2) {
    ...
    function visualize(data) {
        ...
        d3.select("#" + leftPanelID).append("text")
            ...
            .text("Marginal merchant type distribution");
        d3.select("#" + leftPanelID).append("text")
            .attr("x", cx2 + 10)
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .text("Overall product frequency");
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .style("dominant-baseline", "middle")
            .text("Estimated product frequency within the selected merchant type");
        ...
        d3.select("#" + barFreqsID)
            ...
            .style("dominant-baseline", "middle")
            .text("1. saliency of a product refers to the degree to which a product helps differentiate merchant types in general");
        d3.select("#" + barFreqsID)
            .append("a")
            ...
            .style("dominant-baseline", "middle")
            .text("2. relevance of a product to a merchant type refers to the extent to which a product represents the merchant type");
        ...
        var title = chart.append("text")
            ...
            .style("text-anchor", "middle")
            .style("font-size", "16px")
            .text("Top-" + R + " Most Salient Products");
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicLabel.innerHTML = "Selected Merchant Type: <span id='" + topicID + "-value'></span>";
